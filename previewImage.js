...
// Pass this if window is not defined yet
    ...
    _previewImage.prototype.init = function(elList){
        const _this = this
        let obj = {
            "urls": [],
            current : ''
